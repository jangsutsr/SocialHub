...
if __name__ == '__main__':
	...
	user_id = 2
	access_token = 'EAACEdEose0cBAAZCAXZA7ncQzpHZBqinZBIQSktCPisfRasVRndZAEZAJs1FCdW6SbpThg1VdqPZBxJq7CuwHdZCkjzbE3dT4fOPYfi0WU3gWQ6SAJ8uTV4E39TvEZBZBJE6gKSkZAMKA8dq0cvIrjTCJFcZBBXFvaYdeqDGtkTFp8qEpwZDZD'
	sql('update user_profile set fb_token=%s where id=%s', (user_id,access_token))
	social_init(user_id, access_token=access_token)
